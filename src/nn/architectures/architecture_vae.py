...
class Architecture_VAE(TPPArchitecture):
    ...
    def _compute_elbo_loss(
        ...
        # the Architecture_DDPM convention (the last inter-arrival time is excluded).
        ...
        if self.use_marks:
            ...
            total_elbo = time_elbo + (self.mark_loss_weight / self._ce_normalizer) * ce_loss
    ...
    def _sample_unconditional(
        ...
        Sequence layout (same as Architecture_DDPM):
